...
def parse_and_load_from_model(parser, args_path = None):
...
def add_model_options(parser):
    ...
    # group.add_argument("--mdm_condm", default='text',
    #                    choices=['text', 'audio_ha2g', 'audio_default', 'Tri', 'Tri_ha2g'], type=str,
    #                    help="Architecture types as reported in the paper.")
    group.add_argument("--mdm_condm", default='text',
                     type=str,
                    help="Architecture types as reported in the paper.")
    ...
    group.add_argument("--fixtext", action='store_true',
                       help="")
    group.add_argument("--mlpact", default='silu',
                     type=str,
                       help="")
...
def add_training_options(parser):
    ...
    group.add_argument("--save_dir", type=str, default = '/p300/wangchy/zhiyh/ted_3090',
                       help="Path to save checkpoints and results.")
...
def generate_args(use_motionclip = False, arg_path = None):
    parser = ArgumentParser()
    ...
    return parse_and_load_from_model(parser, arg_path)
...
def add_ted_options(parser):
    group = parser.add_argument_group('ted')
    group.add_argument("-dt", "--data_type", default="shortseq", type= str)
    group.add_argument("-b", "--batch_size", type=int, default=512, help="number of batch_size")
    group.add_argument("-e", "--epochs", type=int, default=1501, help="number of epochs")
    ...
    group.add_argument('--use_cond_motion', default= False, type=bool, help="produce cond motion")
    group.add_argument('--audio_model', default= "default", type=str, help="produce cond motion")
    group.add_argument("-condm",'--condmod', default= 'fft', type=str, help="change speed")
    group.add_argument("--use_New_Split", action='store_true',help="tran decoder audio Q, x KV")
...
def add_motionclip(parser):
    ...
    # group.add_argument("--n_pre_poses", type=int, default=1, help="n_pre_poses")
